...
# Saved on Thu Jun 16 19:41:34 2022
...
#<Session mode="View" path="/home/verifier/project/rkv_labs/AHB-RAM-32b/uvm/sim/rkv_ahbram_debug_wave.do.tcl" type="Debug">
...
gui_wv_zoom_timerange -id ${Wave.1} 0 1394000
gui_list_add_group -id ${Wave.1} -after {New Group} [list ${Group1}]
gui_list_add_group -id ${Wave.1} -after {New Group} [list ${Group2}]
gui_list_select -id ${Wave.1} {rkv_ahbram_tb.ahb_if.haddr }
...
gui_marker_move -id ${Wave.1} {C1} 86018
